    ...
    <>
      <nav>
        <div className="container nav-inner">
          ...
          <div className="nav-links">
            ...
            <Link href="/image-tools" className="btn btn-primary" style={{ padding: '0.4rem 1rem' }}>
              Compress Images
            </Link>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="feature-grid" style={{ gridTemplateColumns: 'repeat(2, 1fr)', gap: '2rem', textAlign: 'left' }}>
            ...
            <div className="feature-card" style={{ padding: '2rem', border: '1px solid var(--border-color)' }}>
              ...
              <p>Convert between formats as part of the compression step. PNG files with transparency stay lossless. JPEG and WebP quality is adjustable from 10% to 100% with a slider. The estimated output size updates as you move it — no surprises on download.</p>
            </div>

            <div className="feature-card" style={{ padding: '2rem', border: '1px solid var(--border-color)' }}>
              <h3>Side-by-side comparison</h3>
              <p>Every processed image has a compare view that shows the original and compressed version at full width. It makes the quality trade-off visible before committing to a download, which matters when compressing photos that will be published or printed.</p>
            </div>

            <div className="feature-card" style={{ padding: '2rem', border: '1px solid var(--border-color)' }}>
              <h3>Batch processing with totals</h3>
              <p>Drop in an entire folder of images at once. NexCompress processes them in sequence and shows a running total of space saved across all files. Download them individually or grab the whole batch as a ZIP with one click.</p>
            </div>

            <div className="feature-card" style={{ padding: '2rem', border: '1px solid var(--border-color)' }}>
              <h3>No upload, no account, no limit</h3>
              <p>Web-based compressors typically cap file sizes at 5–10MB and require sign-up for anything larger. NexCompress runs entirely on your device — the only practical limit is your browser&apos;s available memory, which handles most workflows comfortably.</p>
            </div>
      ...
      <section className="cta-section">
        <div className="container">
          ...
          <Link href="/image-tools" className="btn btn-primary" style={{ marginTop: '2rem' }}>
            Open NexCompress
          </Link>
        </div>
      </section>
