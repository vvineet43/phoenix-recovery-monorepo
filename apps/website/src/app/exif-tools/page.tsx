    ...
    <>
      <nav className="site-nav">
        <div className="container nav-inner">
          ...
          <div className="nav-links">
            ...
            <a href="#tool" className="btn btn-primary" style={{ padding: '0.45rem 0.9rem', fontSize: '0.83rem' }}>
              Strip Metadata
            </a>
          </div>
        </div>
      ...
      <header className="hero container">
        ...
        <div className="hero-actions">
          <a href="#tool" className="btn btn-primary">Open in Browser</a>
        </div>
      </header>

      <section id="tool" style={{ padding: 0 }}>
        <ExifStripperWrapper />
      </section>
      ...
      <section className="cta-section">
        <div className="container">
          ...
          <a href="#tool" className="btn btn-primary">Open NexStrip</a>
        </div>
      </section>
    </>
  );
